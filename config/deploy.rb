...
role :web, "group5.com"                          # Your HTTP server, Apache/etc
role :app, "group5.com"                         # This may be the same as your `Web` server
role :db,  "group5.com"   , :primary => true # This is where Rails migrations will run
