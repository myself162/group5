...
role :web, "check.com"                          # Your HTTP server, Apache/etc
role :app, "check.com"                         # This may be the same as your `Web` server
role :db,  "check.com"   , :primary => true # This is where Rails migrations will run
